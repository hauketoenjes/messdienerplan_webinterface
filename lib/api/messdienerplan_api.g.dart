...
class _MessdienerplanApiClient implements MessdienerplanApiClient {
  ...
  Future<List<Classification>> getClassifications(groupId) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<List<dynamic>>(
        _setStreamType<List<Classification>>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/groups/$groupId/classifications/',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    var value = _result.data!
  ...
  Future<Classification> getClassification(groupId, id) async {
    ...
    final _data = <String, dynamic>{};
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Classification>(
            Options(method: 'GET', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/groups/$groupId/classifications/$id/',
                    queryParameters: queryParameters, data: _data)
                .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
  ...
  Future<Classification> postClassification(groupId, classification) async {
    ...
    final queryParameters = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(classification.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Classification>(
            Options(method: 'POST', headers: <String, dynamic>{}, extra: _extra)
                .compose(_dio.options, '/groups/$groupId/classifications/',
  ...
  Future<Classification> patchClassification(
    ...
    _data.addAll(classification.toJson());
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<Classification>(Options(
                method: 'PATCH', headers: <String, dynamic>{}, extra: _extra)
            .compose(_dio.options, '/groups/$groupId/classifications/$id/',
                queryParameters: queryParameters, data: _data)
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
